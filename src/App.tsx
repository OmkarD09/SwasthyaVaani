  ...
  return (
    <header className="site-nav">
      ...
      <div className="nav-actions">
        ...
        <AppButton onClick={() => setLocation('/patient/consultation')} className="nav-cta">Start intake <ArrowRight size={15} /></AppButton>
      </div>
    </header>
  );
}
      ...
      <section className="hero">
        ...
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <AppButton onClick={() => setLocation('/patient/consultation')} className="hero-primary">Start patient intake <ArrowRight size={17} /></AppButton>
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/patient/review" component={PatientReview} />
      <Route path="/patient/kiosk" component={PatientKiosk} />
