...
import { ArrowLeft, UserRound, Check, ShieldCheck } from 'lucide-react';
...
export function PatientProfile() {
  ...
  return (
    <div className="min-h-screen bg-[var(--sv-paper)] text-[var(--sv-ink)] p-4 md:p-8 flex flex-col justify-between">
      {/* Header */}
      ...
      <main className="w-full max-w-xl mx-auto my-auto py-6">
        <div className="kiosk-card p-6 md:p-8 rounded-2xl shadow-xl border border-emerald-900/10 bg-[var(--sv-card)] space-y-6">
          ...
          {saveSuccess && (
            <div className="flex items-center gap-2 p-3 bg-emerald-100 dark:bg-emerald-950/40 text-emerald-900 text-sm rounded-lg border border-emerald-300">
              <Check size={16} />
          ...
          {isEditing ? (
            <form onSubmit={handleSave} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 rounded-lg border border-emerald-900/20 bg-white text-sm"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 rounded-lg border border-emerald-900/20 bg-white text-sm font-mono"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="py-2 border-b border-emerald-900/5">
                <span className="block text-xs font-mono text-stone-500 uppercase">
                  {getTranslation(language, 'abhaNumberLabel')}
                </span>
              ...
              <div className="pt-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="app-button primary px-5 py-2.5 rounded-lg text-sm font-medium"
                >
                  {getTranslation(language, 'startConsultation')}
                </button>
              </div>
            </div>
          )}
