...
export function PatientAttachments({
  ...
  // A filename stored by the patient UI is not proof that bytes were uploaded.
            ...
            <div className="mt-4 space-y-3">
              <div className="flex items-center justify-between rounded-xl bg-[#eef4ec] p-3 border border-[#d4e2d2] text-xs">
                <div className="flex items-center gap-2 text-[#245b49]">
                  <CircleAlert size={16} className="text-[#9a6700]" />
                  <span>
                ...
                {previewDoc.size && (
                  <span className="font-mono text-[11px] text-[#55786b]">{previewDoc.size}</span>
                )}
              </div>
